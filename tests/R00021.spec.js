...
test('R00021', async ({ page }) => {
    ...
    await page.screenshot({ path: 'C:/Automation-Test/automation_github/img/R00021/R00021-1.png'});
    await page.getByRole('link', { name: '    ออกจากระบบ' }).click();
    await page.screenshot({ path: 'C:/Automation-Test/automation_github/img/R00021/R00021-2.png',fullPage:true });
});